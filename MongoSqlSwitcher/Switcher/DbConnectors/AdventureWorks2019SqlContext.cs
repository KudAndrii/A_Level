...
{
    public partial class AdventureWorks2019SqlContext : DbContext
    {
        private readonly string _connectionString;

        public AdventureWorks2019SqlContext()
        {
            _connectionString = Environment.GetEnvironmentVariable("AdventureDbConnection");
        }

        public AdventureWorks2019SqlContext(DbContextOptions<AdventureWorks2019SqlContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<BusinessEntityContactCopy> BusinessEntityContactCopies { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BusinessEntityContactCopy>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("BusinessEntityContactCopy");
